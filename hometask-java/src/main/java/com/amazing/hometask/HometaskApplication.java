package com.amazing.hometask;

import com.amazing.hometask.model.Component;
import com.amazing.hometask.model.Request;
import com.amazing.hometask.repository.RequestRepository;
...
public class HometaskApplication {
	...
	CommandLineRunner init(RequestRepository repository) {
		return args -> {
			...
			var request3 = new Request("Hardware for the chess club", "Accepted", 795.00, List.of(component4, component5, component6));
